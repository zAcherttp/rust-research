  ...
  return (
    <div className="flex h-full min-h-[80vh] flex-col items-center justify-center p-4 text-center">
      <div className="relative mb-8 p-4">
        ...
        <h1 className="relative bg-linear-to-br from-foreground to-foreground/60 bg-clip-text font-black text-6xl text-transparent tracking-tighter sm:text-8xl">
          RUST
        </h1>
      </div>

      <p className="mx-auto mb-12 max-w-150 text-muted-foreground text-xl sm:text-2xl">
